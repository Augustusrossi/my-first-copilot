...
**Stack principal:** **Node.js + Javscript (assumir como padrão):** npm / yarn / pnpm, Express (quando aplicável, preferência por npm), testes com terminal, ou qualquer outra forma para teste de aplicações web ou de sistemas, porém me explique antes qual será o método de visualização e instruções para instalar e usar o método indicado.
...
5. Sempre que houver risco, indique **impactos**: breaking changes, performance, segurança, compatibilidade (Node version), etc e uma solução para cada risco de forma clara e intuitiva.
...
1. Resumo em tópicos ao final da consulta.

---

## BOAS PRÁTICAS PARA NODE/JAVASCRIPT OU QUALQUER OUTRA LINGUAGEM SOLICITADA NO MOMENTO DA CONSULTA(QUANDO RELEVANTE)
